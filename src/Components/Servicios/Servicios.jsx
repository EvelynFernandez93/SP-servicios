    ...
    <div className='servicios-contenedor'>
      ...
      <div className='contenedor-cards'>
        <div className='card'>
            ...
            <p className='card-texto '>Asesoramiento profesional para alumnos, gasista matriculados, arquitectos, entre otros.</p>   
        </div>
        <div className='card'>
            <img className='card-img' src='/Card1.png'></img>
        ...
        <div className='card'>
            ...
            <p className='card-texto '>Incluye reparacioes, intalación de cañerías, tramitación de medidor y control de calidad..</p>   
        </div>
